...
function Perfil() {
    ...
    useEffect(() => {
        ...
        fetch(`${import.meta.env.VITE_API_URL}/usuario/perfil`, {
    ...
    const handleSalvar = async () => {
        try {
            ...
            const resposta = await fetch(`${import.meta.env.VITE_API_URL}/usuario/atualizar`, {
                method: "PUT",
                headers: {
            ...
            <div className="div-topo">
                ...
                {usuario.imagem && (
                    <img className="imagem-perfil"
                        src={`${import.meta.env.VITE_API_URL}/uploads/${usuario.imagem}`}
                        alt="Usuário"
                        width={160}
                    />
                )}
